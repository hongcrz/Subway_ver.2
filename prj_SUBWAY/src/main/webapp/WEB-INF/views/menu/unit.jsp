...
<!-- 여기서부터 menuList/sandwich 영역입니다  -->
	<div class="body" style=" width : 100%;">
    	...
    	<div style="overflow: hidden;">
    		<div style="background-color:#85c441; background:; width: 100%; height: 380px; background-position: center;">
	    	...
	    	<div class="regBtn-div" style=" text-align: center; padding-top: 20px;">
    			...
    			<div style="padding: 2%; height: 100%;  ">	 
    				<ul class = "tab_content">
    					...
    					<!-- 상세 카테고리 all  -->
    					<li class="all">
    						<c:forEach var="vo" items="${list_unit_all}">
    						<ul>
						...
						<!-- 상세 카테고리 클래식  -->
						<li>
							<c:forEach var="vo" items="${list_unit_classic}">
    						<ul>
    							<li class="detail-more" onclick="location.href='javascript:;void(0);'" style="position: apsolute; z-index: 3;">
		    						<div class="img">
		    							<img src="${vo.purl }">
						...
						<!-- 상세 카테고리 프래쉬 & 라이트  -->
						<li>
						<c:forEach var="vo" items="${list_unit_fresh}">
    						<ul>
						...
						<!-- 상세 카테고리 프리미엄  -->
						<li>
							<c:forEach var="vo" items="${list_unit_premium}">
    						<ul>
    							<li class="detail-more" onclick="location.href='javascript:;void(0);'" style="position: apsolute; z-index: 3;">
		    						<div class="img">
		    							<img src="${vo.purl }">
						...
						<li>
						<c:forEach var="vo" items="${list_unit_plus}">
    						<ul>
    							<li class="detail-more" onclick="location.href='javascript:;void(0);'" style="position: apsolute; z-index: 3;">
		    						<div class="img">
		    							<img src="${vo.purl }">
