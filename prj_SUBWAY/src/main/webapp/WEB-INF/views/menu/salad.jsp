  ...
  function remove_event(f){
  	...
  	<div class="body" style=" width : 100%;">
    	<div style="overflow: hidden;">
    		<div style="background-color:#0d9133; background:; width: 100%; height: 380px; background-position: center;">
	    	...
	    	<div class="regBtn-div" style=" text-align: center; padding-top: 20px;">
    			...
    			<div style="padding: 2%; height: 100%;  ">
    				<ul class = "tab_content">
    					...
    					<!-- 상세 카테고리 all  -->
    					<li class="all">
    						<c:forEach var="vo" items="${list_salad_all}">
    						<ul>
						...
						<li>
							<c:forEach var="vo" items="${list_salad_classic}">
    						<ul>
    							<li class="detail-more" onclick="location.href='javascript:;void(0);'" style="position: apsolute; z-index: 3;">
		    						<div class="img">
		    							<img src="${vo.purl }">
						...
						<li>
							<c:forEach var="vo" items="${list_salad_fresh}">
    						<ul>
    							<li class="detail-more" onclick="location.href='javascript:;void(0);'" style="position: apsolute; z-index: 3;">
		    						<div class="img">
		    							<img src="${vo.purl }">
						...
						<li>
							<c:forEach var="vo" items="${list_salad_premium}">
    						<ul>
    							<li class="detail-more" onclick="location.href='javascript:;void(0);'" style="position: apsolute; z-index: 3;">
		    						<div class="img">
		    							<img src="${vo.purl }">
						...
						<li>
							<c:forEach var="vo" items="${list_salad_plus}">
    						<ul>
    							<li class="detail-more" onclick="location.href='javascript:;void(0);'" style="position: apsolute; z-index: 3;">
		    						<div class="img">
		    							<img src="${vo.purl }">
