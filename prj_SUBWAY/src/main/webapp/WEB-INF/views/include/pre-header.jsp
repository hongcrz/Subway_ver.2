...
<body>
	...
	<div class="header">
		...
		<div style="text-align: center; padding: 2%; padding-left: 22%;">
			<a href="/"><img alt="" src="../../../resources/image/Logo/logo_w.png"></a>
		</div>
				...
				<div class="collapse navbar-collapse" id="ftco-nav">
					<ul id="main_menu" class="navbar-nav m-auto">
						<li class="nav-item"><a href="#" class="nav-link"
							style="font-size: 18px; color: black;">브랜드</a>
							<div>
								<ul id="sub_menu"
						...
						<li class="nav-item"><a href="#" class="nav-link"
							style="font-size: 18px; color: black;">메뉴소개</a>
							<div>
						...
						<li class="nav-item"><a href="#" class="nav-link"
							style="font-size: 18px; color: black;">이용방법</a>
							<div>
								<ul id="sub_menu" style="background-color: white; width: 100%;">
						...
						<li class="nav-item"><a href="#" class="nav-link"
							style="font-size: 18px; color: black;">새소식</a>
							<div>
								<ul id="sub_menu" style="background-color: white; width: 100%;">
						...
						<li class="nav-item"><a href="#" class="nav-link"
							style="font-size: 18px; color: black;">온라인주문</a>
							<div>
								<ul id="sub_menu" style="background-color: white; width: 100%;">
